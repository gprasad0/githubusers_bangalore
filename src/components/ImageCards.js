    ...
    let renderUsers = this.props.data.map((user, index) => {
        return (
          <div
            ...
            onClick={() =>
              this.onClickImage(user.forks, users[index].avatar_url,users[index].login,users[index].html_url,users[index].score)
            }
          >
            <div className="item">
    ...
    return (
      <div className="wrapper">
          ...
          <div className="ui card userRender">
            ...
            <div class="content">
              ...
              <div class="description">
                <a href= {this.state.html_url}>Click here for {this.state.login} github page</a>
              </div>
            </div>
        ...
        <div className="">
          ...
          <div className="renderUsers renderUsersScroll" style={{width:"400px"}}>{renderUsers}</div>
